    ...
    return (
        <main>
            <section className={styles.hero}>
                <picture>
                    <source
                        srcSet="/assets/about/desktop/image-hero-whitecup.jpg"
                ...
                <div className={styles.text}>
                    <h1>About Us</h1>
                    <p className={barlow.className}>Coffeeroasters began its journey of exotic discovery in 1999, highlighting stories of coffee from around the world. We have since been dedicated to bring the perfect cup - from bean to brew - in every shipment.</p>
                </div>
            ...
            <section className={styles.locations}>
                ...
                <div className={styles["locations-flex"]}>
                    <div className={styles.location}>
                        ...
                        <div className={`${styles.address} ${barlow.className}`}>
                            <p>68  Asfordby Rd</p>
                            <p>Alcaston</p>
                            <p>SY6 1YA</p>
                            <p>+44 1241 918425</p>
